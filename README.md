# laravel+vue+postgresql admin panel
The project use easily and minimizable


## About Repository

A very simple Laravel 8 + Vue 2 + AdminLTE 3 based admin template for SPA Application.
<p align="center">
...
- Laravel 8
- PostgreSQL
- Vue 2 + VueRouter + Vue Auth + sweetalert2 + laravel-vue-pagination
- Laravel Passport
